export default {
  en: {
    ...
    flagFound: "Flag found, submitted! You will receive a notification about the submission status in a few seconds.",
    acceptedChallenges:
...
<li> Log in to your account after cleaning your web browser's private data. </li>
  ...
  pt: {
    ...
    flagFound: "Flag encontrada, enviada! Você receberá uma notificação sobre o status do envio em alguns segundos.",
    acceptedChallenges:
      "The {challenges} submission(s) was accepted. In a few minutes it will count.",
    notAcceptedChallenges:
