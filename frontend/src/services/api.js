...
export const API = {
  ...
  getChallenges: () => api.get("/challenges/index.json", { baseURL: "https://pwn2.win/2019/" }),// TODO remove baseURL
  getChallenge: (challenge) => api.get(`/challenges/${challenge}.json`, { baseURL: "https://pwn2.win/2019/" }),// TODO remove baseURL
  getTeam: teamName => {
